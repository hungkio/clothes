...
if (!function_exists('pos_put_purchase_url')) {
    function pos_put_purchase_url($purchase_id)
    {
        $url = config('app.pos_uri') . config('app.pos_shop_id') . "/purchases/$purchase_id?api_key=" . config('app.pos_api_key');
        return $url;
    }
}
